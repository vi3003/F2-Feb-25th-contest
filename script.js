const newRowBtn = document.getElementById("bttn")
...
newRowBtn.addEventListener("click", () => {
  ...
  <td><button class="save-btn" onclick="submitdata(document.getElementById('stuname').value,document.getElementById('rollno').value,document.getElementById('subject').value,document.getElementById('marks').value,document.getElementById('markedby').value)">Save</button></td>
  </form>`
